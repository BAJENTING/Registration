...
if ($_SERVER["REQUEST_METHOD"] === "GET"){
    ...
    if ($campus === 'all'){
        ...
        $check = "SELECT * from registration where campus = '$campus'";
    } else {
                $check = "SELECT * FROM registration WHERE 1=0";
    }

    $result = $conn->query($check);
    $rCount = "SELECT count(*) from registration where campus = '$campus'";
    $aCount = "SELECT count(idNum) from registration where attended = 'Yes'";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <?php
    echo "<h5> # of Registrants: ".$rCount."</h5>";
    ?>
</body>
</html>